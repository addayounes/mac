        ...
        <div>
            <div>
                ...
                <div className="about-us__description stretch">
                    <p className="container-about">Mechanical Activities Club (MAC) a été fondé en 2014 par les futurs ingénieurs en génie mécanique (majoritairement ceux en 1er et 2eme année), afin de créer la solidarité et l’union entre les étudiants, les encourager, et éclaircir leur vision vis-à-vis du monde professionnel.</p>
                </div>
